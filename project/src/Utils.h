...
#pragma warning(disable : 4505) //Warning unreferenced local function
		static bool ParseOBJ(const std::string& filename, std::vector<Vertex_PosColTex>& vertices, std::vector<uint32_t>& indices, bool flipAxisAndWinding = true)
		{
